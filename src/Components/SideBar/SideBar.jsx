        ...
        <div className="drawer md:drawer-open">
            ...
            <div className="drawer-side">
                ...
                <ul className={`menu ${sidebarWidth} w-[264px] min-h-full bg-[#fff] dark:bg-[#2E1619] text-base-content`}>
                    ...
                    <li className={`text-[16px] dark:text-white mt-[60px] font-mono ${changeLogo ? '' : 'mx-auto'}`}><a href="/"><img className="w-8" src="https://i.ibb.co/fYjhfBf/Icon-home.png" alt="" /><span className={`${hideText}`}>Home</span></a></li>
                    <li className={`text-[16px] dark:text-white mt-5 font-mono ${changeLogo ? '' : 'mx-auto'}`}><a href="/allemployee"><GoPerson className="text-[32px]"/><span className={`${hideText}`}>All Employee</span></a></li>
                    <li className={`text-[16px] dark:text-white mt-5 font-mono ${changeLogo ? '' : 'mx-auto'}`}><a href="/createEmployee"><LiaCalendarSolid className="text-[32px]"/><span className={`${hideText}`}>Create Employee</span></a></li>
                    <li className={`text-[16px] dark:text-white mt-5 font-mono ${changeLogo ? '' : 'mx-auto'}`}><a><LiaCalendarSolid className="text-[32px]"/><span className={`${hideText}`}>Update Employee</span></a></li>
